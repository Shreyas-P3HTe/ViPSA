...
from vipsa.hardware.Movement import Zaber
...
class VipsaGUI:
    ...
    def create_window(self):
             ...
             sg.Column([
                 ...
                 [sg.Text("Select SMU:", size=(10,1)),
                    sg.Combo(
                        ...
                        readonly=True,
                        size=(20,1))],
                 [sg.Button("Quick Align âŒ–", key = '-QUICK_ALIGN-'), sg.Button("Quick Approach â˜Ÿ", key = '-QUICK_APPROACH-' )]
             ], vertical_alignment='top')]
        ]
        ...
        measure_tab = [
            ...
            [sg.Text("Save Folder:", size=(10,1)), sg.InputText(DEFAULT_SAVE_DIRECTORY, key='-MEAS_SAVE_FOLDER-', size=(50, 1)), sg.FolderBrowse()],
             [sg.Checkbox("Align First", default=False, key='-MEAS_ALIGN-'),
              ...
              sg.Text("Wait betâ¿ measurements for:", size=(10,1)), sg.InputText("0", key='-WAIT_TIME-', size=(5, 1))],
        ...
        protocol_editor_layout = [
             ...
             [sg.Button('âž• Add Step', key='-ADD_TEST-', size=(15, 1)), 
              sg.Button('âœ Edit Selected', key='-EDIT_TEST-', size=(15, 1)),
              sg.Button('ðŸ—‘ Remove Selected', key='-REMOVE_TEST-', size=(15, 1)),
              sg.Button('Clear All', key='-CLEAR_PROTOCOL-', size=(12, 1))],
             [sg.Button('ðŸ’¾ Save Protocol', key='-SAVE_PROTOCOL-', size=(15, 1)), 
              sg.Button('ðŸ“‚ Load Protocol', key='-LOAD_PROTOCOL-', size=(15, 1))],
        ]
        protocol_viewer_layout = [
             [sg.Text('Protocol Steps:', font='_ 11 bold')],
             [sg.Listbox(values=[], size=(60, 12), key='-TEST_LIST-', enable_events=True)],
             [sg.Text('Double-click to edit â€¢ Right-click to remove', text_color='gray', size=(40, 1))],
             [sg.Button('â–¶ Run Protocol on Current Target', key='-RUN_PROTOCOL_SINGLE-', size=(38, 1), button_color=('white', 'green'))],
        ]
