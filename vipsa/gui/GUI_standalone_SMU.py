...
from vipsa.hardware.Source_Measure_Unit import KeysightSMU # Make sure this file is accessible
from vipsa.analysis.Datahandling import Data_Handler # Make sure this file is accessible
...
class PlottingHandler(Data_Handler): # Inherit from Data_Handler
    ...
    def save_manual_file(self, data, data_name, sample_id, device_id, save_directory=None):
        ...
        try:
            ...
            df['Contact Current (A)'] = 0.0
            df['Z position'] = np.nan
